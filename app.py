...
# -------------------------------------------------------------
tab_portfolio, tab_alerts, tab_rankings4, tab_news, tab_overview, tab_deepdive, tab_simulator = st.tabs([
    "💼 Minha Carteira",
    "🚨 Alertas B3",
...
with tab_portfolio:
    ...
    with col_alert_hdr:
        st.markdown("#### 🚨 Alertas de Proventos do Mês da Carteira")
    ...
    # 💰 Gráficos Executivos da Carteira: Pizza 1, Pizza 2 e Barra 3
    ...
    with col_cad:
        st.markdown('<div class="pbi-chart-title">📝 Cadastrar / Atualizar Ativo na Carteira</div>', unsafe_allow_html=True)
    ...
    with col_hist:
        st.markdown('<div class="pbi-chart-title">📜 Histórico Completo das Atualizações & Lançamentos</div>', unsafe_allow_html=True)
...
with tab_alerts:
    ...
    with col_a_m1:
        st.markdown("#### 🚨 1. Alertas de Proventos do Mês da B3")
    ...
    st.markdown("#### 🔻 2. Alertas de Ações Abaixo do Valor de Compra (Preço < PM) da B3")
...
# =============================================================
# 4. ABA NOTÍCIAS REAIS & DADOS DA B3
# =============================================================
with tab_news:
    st.markdown("### 📰 Notícias Reais & Análise de Sentimento das Empresas da B3")
...
with tab_overview:
    ...
    st.markdown("<br>", unsafe_allow_html=True)
    st.markdown('<div class="pbi-chart-title">🗓️ Calendário Anual de Proventos da B3</div>', unsafe_allow_html=True)
    render_monthly_calendar_grid(filtered_df.to_dict("records")[:12])

# =============================================================
# 6. ABA RAIO-X INDIVIDUAL (BAZIN & GRAHAM)
# =============================================================
with tab_deepdive:
...
# =============================================================
# 7. ABA SIMULADOR DE RENDA PASSIVA
# =============================================================
with tab_simulator:
